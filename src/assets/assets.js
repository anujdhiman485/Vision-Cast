...
export const AiToolsData = [
    {
        ...
        description: 'Generate high-quality,Images from AI.',
        Icon: SquarePen,
    ...
    },
    {
        ...
        description: 'Make the perfect Videos from AI for Posting .',
        Icon: Hash,
        bg: { from: '#B153EA', to: '#E549A3' },
        path: '/ai/generate-videos'
    },
    {
        title: 'Post on Meta ',
        description: 'Post and Schdule on Instagram and Facebook ',
        Icon: Image,
    ...
    {
        title: 'Post on X',
        description: 'Post on X(Twitter) Seemlesly',
        Icon: Eraser,
